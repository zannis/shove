...
document, the in-process batch flow drains 3-10x faster than the plain parallel
consumer at 64 B and 2-7x faster at 1 KiB, and 2-4x slower at 64 KiB — so what
turns the comparison around is payload size. Those 64 KiB rows are read from
