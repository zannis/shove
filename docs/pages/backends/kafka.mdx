...
For the default missing-topic behavior and the auto-creation switch, see [`KafkaConfig::with_producer_auto_create_topics`](https://docs.rs/shove/latest/shove/kafka/struct.KafkaConfig.html#method.with_producer_auto_create_topics).
