...
//!
//!     cargo bench -q --features rabbitmq --bench stress
//!     cargo bench -q --features rabbitmq --bench stress -- --tier moderate
//!     cargo bench -q --features rabbitmq --bench stress -- --tier extreme
