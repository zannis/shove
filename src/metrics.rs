...
/// backends do not drift apart the next time one of them is touched. Kafka,
/// NATS and Redis have no cascade sites because they do not implement
/// [`SequenceFailure`] at all — if sequencing lands on one of them, its
/// poisoning site belongs on this list.
///
...
///
/// [`SequenceFailure`]: crate::topology::SequenceFailure
