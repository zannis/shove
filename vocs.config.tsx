  ...
  editLink: {
    pattern: (pageData) => {
      ...
      const exampleMap: Record<string, string> = {
        ...
        'backends/redis/examples/consumer-groups.mdx': 'examples/redis/consumer_groups.rs',
        'backends/redis/examples/autoscaler.mdx': 'examples/redis/autoscaler.rs',
        'backends/redis/examples/audited.mdx': 'examples/redis/audited_consumer.rs',
        'backends/redis/examples/stress.mdx': 'examples/redis/stress.rs',
      ...
      items: [
        ...
        },
        {
          ...
          items: [
            ...
            { text: 'Consumer Groups', link: '/backends/redis/examples/consumer-groups' },
            { text: 'Autoscaler', link: '/backends/redis/examples/autoscaler' },
            { text: 'Audited Consumer', link: '/backends/redis/examples/audited' },
            { text: 'Stress', link: '/backends/redis/examples/stress' },
          ],
        },
        {
          text: 'In-process',
